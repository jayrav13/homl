...
- (void)setHoleRadiusPrecent:(double)holeRadiusPrecent {
    _holeRadiusPrecent = holeRadiusPrecent;
    [self setFrame:self.frame];
}

- (void)setRadiusPrecent:(double)radiusPrecent {
    _radiusPrecent = radiusPrecent;
    [self setFrame:self.frame];
}
